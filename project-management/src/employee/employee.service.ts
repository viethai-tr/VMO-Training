...
export class EmployeeService {
    ...
    async getAllEmployees(limit?: number, page?: number, sort?: string): Promise<EmployeeDocument[]> {
        return await this.employeeRepository.getAllEmployeesAsync(limit, page, sort);
    }
